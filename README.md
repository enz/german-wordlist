...
with Unix-style line endings. The rules for including words roughly
follow the rules of Scrabble, which means that names, proper nouns,
...
lot of mistakes. Any help improving them is appreciated.
